...
RAW_HTML = PROJECT_ROOT / "data" / "raw" / "puro_earth" / "projects.html"
OUTPUT_CSV = PROJECT_ROOT / "data" / "processed" / "puro_earth" / "puro_projects.csv"
...
def parse_projects(html_path: Path = RAW_HTML) -> pd.DataFrame:
    ...
    for tr in table.find_all("tr"):
        ...
        project_link = project_cell.find("a", href=True)
        ...
        records.append(
            {
                ...
                "country": clean_country(values.get("country")),
...
def main() -> None:
    ...
    print(f"Parsed {len(df)} Puro Earth projects")
    print("Columns:")
